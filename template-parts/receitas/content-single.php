    ...
    <div class="flex gap-10">
        ...
        <div class="flex-1 overflow-hidden">
            <?php if (has_post_thumbnail()) : ?>
                <?php
                echo $post_thumbnail = get_the_post_thumbnail(null, 'post-thumbnail', array('class' => 'hover:scale-125 transition duration-500 cursor-pointer object-cover'));
                ?>
            <?php else : ?>
        ...
        <div class="flex-1">
            <header class="mb-6">
                ...
                <div class="flex gap-2">
                    ...
                    ?>
                        <span class="border-2 border-primary/20 text-dark text-xs font-normal w-auto h-6 flex px-2.5 py-0.5 items-center justify-center rounded-full"><?php echo $category->name ?></span>
                    <?php
                    }
                    ?>
                    <div class="border-2 border-primary/20 text-dark text-xs font-normal w-6 h-6 flex items-center justify-center rounded-full">
